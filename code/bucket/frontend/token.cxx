...
Token Token::characterLiteral(SourceFile::Position begin, SourceFile::Position end, support::UnicodeCharacter character_literal)
{
...
support::UnicodeCharacter* Token::getCharacterLiteral()
{
